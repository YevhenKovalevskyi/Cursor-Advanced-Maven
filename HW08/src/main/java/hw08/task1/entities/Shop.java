...
public class Shop {
    ...
    @NotEmpty(message = "Name cannot be be null or empty!")
    @Column(name="s_name", columnDefinition = "VARCHAR(100) NOT NULL")
    private String name;
    
    @NotEmpty(message = "City cannot be be null or empty!")
    @Column(name="s_city", columnDefinition = "VARCHAR(50) NOT NULL")
    private String city;
    
    @NotEmpty(message = "Address cannot be be null or empty!")
    @Column(name="s_address", columnDefinition = "VARCHAR(100) NOT NULL")
    private String address;
    
    @PositiveOrZero(message = "HasSite is invalid!")
